...
class Ui_AddProductWindow(object):
    def setupUi(self, AddProductWindow):
        ...
        AddProductWindow.resize(439, 490)
        self.centralwidget = QWidget(AddProductWindow)
...
"")
        ...
        self.horizontalLayout_34.setSizeConstraint(QLayout.SizeConstraint.SetNoConstraint)
...
"")
        ...
        self.horizontalLayout_34.addWidget(self.ProveedorButton)
        ...
        self.agregarButton = QPushButton(self.widget_12)
        self.agregarButton.setObjectName(u"agregarButton")
        self.agregarButton.setMinimumSize(QSize(231, 0))
        self.agregarButton.setMaximumSize(QSize(231, 16777215))
        font2 = QFont()
        font2.setPointSize(15)
        font2.setBold(True)
        self.agregarButton.setFont(font2)
        self.agregarButton.setCursor(QCursor(Qt.PointingHandCursor))
        self.agregarButton.setStyleSheet(u"border-radius:8px;\n"
"color: rgb(31, 159, 239);\n"
"background-color: rgb(255, 255, 255);\n"
"height:30px;")

        self.verticalLayout_4.addWidget(self.agregarButton, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, AddProductWindow):
        AddProductWindow.setWindowTitle(QCoreApplication.translate("AddProductWindow", u"Agregar Producto", None))
        self.labelNombre.setText(QCoreApplication.translate("AddProductWindow", u"Nombre:", None))
        self.labelInventario.setText(QCoreApplication.translate("AddProductWindow", u"Inventario:", None))
        self.labelPrecio.setText(QCoreApplication.translate("AddProductWindow", u"Precio:", None))
        self.labelDescripcion.setText(QCoreApplication.translate("AddProductWindow", u"Descripci\u00f3n:", None))
        self.labelCodigoBarras.setText(QCoreApplication.translate("AddProductWindow", u"C\u00f3digo:", None))
        self.labelCategoria.setText(QCoreApplication.translate("AddProductWindow", u"Categor\u00eda:", None))
        self.labelMarca.setText(QCoreApplication.translate("AddProductWindow", u"Marca:", None))
        self.labelProveedor.setText(QCoreApplication.translate("AddProductWindow", u"Proveedor:", None))
        self.labelCantidad.setText(QCoreApplication.translate("AddProductWindow", u"Cantidad:", None))
        self.labelPorcentajeOperacion.setText(QCoreApplication.translate("AddProductWindow", u"Porcentaje:", None))
        self.categoriaButton.setText(QCoreApplication.translate("AddProductWindow", u"+", None))
        self.marcaButton.setText(QCoreApplication.translate("AddProductWindow", u"+", None))
        self.ProveedorButton.setText(QCoreApplication.translate("AddProductWindow", u"+", None))
        self.agregarButton.setText(QCoreApplication.translate("AddProductWindow", u"Nuevo Producto", None))
    # retranslateUi
